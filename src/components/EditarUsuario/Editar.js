...
const body = {
  ...
  //Como essa função n trás uma resposta n é necessário guardar o axios em um const res
  await axios.put(`${BASE_URL}/${usuario.id}`, body, {headers: {Authorization: AUTH_TOKEN,},})
    getDadosUsuario();
    setEditar(!editar);
    } catch(error){
      console.log(error.response);
